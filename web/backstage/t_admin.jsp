    ...
    <script>
        ...
        function update() {
            ...
            if ($("#updateForm").form("validate")) {
                $.post('<%=path%>/admin/update', $("#updateForm").serialize());
        ...
        function removePro() {
            ...
            if (row) {
                $.post('<%=path%>/admin/delete', {'id': row.t_adm_id});
                $("#list").datagrid("reload");
            } else {
...
<table id="list" class="easyui-datagrid" toolbar="#tb" data-options="
    ...
    <thead>
    <tr>
        <th data-options="field:'t_adm_id',checkbox:true"width="100">管理编号</th>
...
<div id="editWin" class="easyui-window" title="修改管理" data-options="iconCls:'icon-edit', closable:true, closed:true"  style="width:500px;height:200px;padding:5px;">
    <form id="updateForm" enctype="multipart/form-data">
        <table>
            <tr>
                <td>管理编号</td>
                <td>
                    <input class="textbox" name="t_adm_id" readonly />
                </td>
            </tr>
            <tr>
                <td>姓名</td>
