...
<table style="margin-left:10px;margin-top:3px;">
    <tr>
         <td>大类名称：</td>
		 <td><input type="text" name="classname" style="width:400px;" placeholder='请输入大类名称'/></td>
    </tr>
	<tr>
         <td>介绍：</td>
		 <td><input type="text" name="classname" style="height: 100px;width:400px;" placeholder='请输入大类详情'/></td>
    </tr>
